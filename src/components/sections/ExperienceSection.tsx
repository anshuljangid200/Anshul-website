...
const experiences = [
  {
    ...
    company: "OnCanvas | Aryans Art",
    period: "Jan 2026 - Present",
    description:
      "Co-founded and lead engineering for a D2C e-commerce platform digitizing precision CNC & laser-cut temples and interior decor for national and international markets. Built full-stack platform and launched brand SEO strategy.",
    impact: ["Next.js & PostgreSQL platform", "AWS & Vercel deployment", "SEO & Cloud Infrastructure setup"],
    icon: Rocket,
  },
  {
    id: 2,
    ...
    company: "Achintya Softech",
    period: "Nov 2025 - Present",
    description:
      "Ship enterprise full-stack features using Spring Boot, React, and Node.js. Build scalable event-driven architectures (Kafka) and integrate Generative & Agentic AI solutions to automate workflows.",
    impact: ["Java Spring Boot & Kafka APIs", "Kubernetes & CI/CD multicloud", "GenAI workflow integrations"],
    icon: Building2,
  },
  {
    id: 3,
    type: "research",
    title: "ML Research Intern – Cybersecurity",
    company: "IIT Gandhinagar",
    period: "Jun 2025 - Oct 2025",
    description:
      "Developed privacy-preserving federated learning models for distributed IoT intrusion detection. Applied EWC to reduce catastrophic forgetting and automated ML evaluation with Agentic AI.",
    impact: ["+14% intrusion detection accuracy", "30% reduction in forgetting", "0.94 F1-score on 1M+ packets"],
    icon: GraduationCap,
  },
  {
    id: 4,
    ...
    company: "KVONTech / Ditanbiz India",
    period: "Nov 2024 - May 2025",
    description:
      "Launched SEO-optimized Next.js portals and high-throughput Node.js APIs. Crafted 30+ accessible (WCAG-compliant) UI components and optimized PostgreSQL/MongoDB schemas.",
    impact: ["+35% search ranking lift", "50% latency cut using Redis", "30+ Figma to WCAG components"],
    icon: Building2,
  },
];
